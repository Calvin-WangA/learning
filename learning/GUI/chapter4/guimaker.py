...
class GuiMaker(Frame):
    ...
    def makeMenuBar(self):
        ...
        expand=no fill=x so same with on resize
        """
    ...
    def makeToolBar(self):
        """
        make button bar at bottom, if any expand=no, fill=x so same width
        on resize this could support images too: see chapter 9
