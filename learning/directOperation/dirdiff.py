...
def reportdiffs(unique1,unique2,dir1,dir2):
    """
    Generate different report for one dir: part of comparedirs output
    """
...
def comparedirs(dir1,dir2,files1=None,files2=None):
    ...
    """
    print('Compareing',dir1,'to',dir2)
    files1 = os.listdir(path=dir1) if files1 is None else files1
